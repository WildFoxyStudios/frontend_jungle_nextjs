...
import {
  ...
  SpeakerIcon, MonitorSmartphone, Code, MailPlus,
  Send, GamepadIcon, Tag, Star as StarIcon, Map, Plug, Cloud,
  Timer, Cog, RefreshCw, History, Scale, FileBadge, ShieldMinus, MessageSquare,
  ListFilter, Server, Plus,
  type LucideIcon,
} from "lucide-react";
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/users/banned", label: "Banned Users", icon: Ban },
      { href: "/users/roles", label: "Roles", icon: ShieldMinus },
      { href: "/users/send-email", label: "Send Email", icon: Send },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/moderation/forum-threads", label: "Forum Threads", icon: MessageSquare },
      { href: "/moderation/forum-messages", label: "Forum Replies", icon: MessageCircle },
    ],
  },
  {
    label: "Content",
    items: [
      ...
      { href: "/content/forums/sections", label: "Forum Sections", icon: FolderOpen },
      { href: "/content/forums/create", label: "New Forum", icon: Plus },
      { href: "/content/live", label: "Live Streams", icon: Radio },
    ],
  },
  {
    label: "Communities",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/payments/requests", label: "Payment Requests", icon: ListFilter },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/settings/email-security", label: "Email Security", icon: ShieldCheck },
      ...
      { href: "/settings/pro", label: "Pro Subscriptions", icon: Star },
      { href: "/settings/affiliates", label: "Affiliates", icon: Handshake },
      { href: "/settings/custom-code", label: "Custom Code", icon: Code },
      { href: "/settings/third-party", label: "Third-Party & Pixels", icon: Plug },
    ],
  },
  {
    label: "Localization",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/customization/terms-pages", label: "Terms Pages", icon: Scale },
      ...
      { href: "/customization/groups-fields", label: "Group Fields", icon: ListChecks },
      { href: "/customization/pages-fields", label: "Page Fields", icon: ListChecks },
      { href: "/customization/products-fields", label: "Product Fields", icon: ListChecks },
    ],
  },
  {
    label: "System",
    items: [
      { href: "/system/node", label: "Node Status", icon: Server },
      { href: "/system/health", label: "Health", icon: HeartPulse },
      { href: "/system/manage-updates", label: "Manage Updates", icon: RefreshCw },
      { href: "/system/changelog", label: "Changelog", icon: History },
      { href: "/system/backups", label: "Backups", icon: HardDrive },
      { href: "/system/upload-storage", label: "Storage", icon: Cloud },
      { href: "/system/sitemap", label: "Sitemap", icon: Map },
      ...
      { href: "/system/cronjobs", label: "Cron Jobs", icon: Timer },
      { href: "/system/auto-settings", label: "Auto Settings", icon: Cog },
      { href: "/system/oauth-apps", label: "OAuth Apps", icon: Key },
      { href: "/system/api-keys", label: "API Keys", icon: KeySquare },
      { href: "/system/third-party", label: "Third-Party Sites", icon: Plug },
      { href: "/system/games", label: "Games", icon: GamepadIcon },
      { href: "/system/offers", label: "Offers", icon: Tag },
      { href: "/system/reviews", label: "Reviews", icon: StarIcon },
      ...
      { href: "/system/invitation-keys", label: "Invitation Keys", icon: FileBadge },
    ],
  },
];
