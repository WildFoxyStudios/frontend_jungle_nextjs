...
function FilesTab({ conversationId }: { conversationId: number }) {
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="flex items-center gap-2 border-2 border-transparent p-2 transition-colors hover:border-foreground hover:bg-secondary/60"
 >
...
function MessageSnippet({
 ...
 className="flex w-full items-start gap-2 border-2 border-transparent p-2 text-left transition-colors hover:border-foreground hover:bg-secondary/60"
 >
