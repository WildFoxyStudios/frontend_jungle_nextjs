...
export function PollVoting({ poll, postId }: PollVotingProps) {
 ...
 return (
 <div className="space-y-3 bg-muted/40 p-3.5 rounded-lg">
 ...
 className="h-auto min-h-10 w-full justify-between border px-3 py-2 text-sm font-semibold hover:bg-muted/30"
 ...
 {isExpired ? " · Ended" : ""}
 {!hasVoted && !isExpired ? " · Vote to reveal results" : ""}
 </p>
 </div>
 );
}
