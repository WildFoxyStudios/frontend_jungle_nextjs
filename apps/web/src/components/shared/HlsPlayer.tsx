...
export function HlsPlayer({
 ...
 {isLive && (
 <div className="pointer-events-none absolute left-3 top-3 flex items-center gap-1.5 border border-white/80 bg-red-600 px-2 py-1 text-xs font-semibold text-white">
