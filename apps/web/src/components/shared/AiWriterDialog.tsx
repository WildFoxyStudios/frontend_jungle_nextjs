...
export function AiWriterDialog({ open, onClose, onInsertText, onInsertImage, mode = "post" }: AiWriterDialogProps) {
 ...
 <div className="relative border rounded-lg bg-secondary/40 p-3">
 ...
 selectedImage === url ? "border-primary" : "border-foreground"
 }`}
 >
 <Image src={url} alt={`Generated ${i + 1}`} fill unoptimized className="object-cover" />
 {selectedImage === url && (
