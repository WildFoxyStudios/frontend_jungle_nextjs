...
interface SocialLoginButtonsProps {
 onSuccess?: () => void;
 /** Post-auth route (caller should pass only sanitized internal paths). */
 postLoginHref?: string;
}

export function SocialLoginButtons({ onSuccess, postLoginHref = "/feed" }: SocialLoginButtonsProps) {
 ...
 }, [handleAuthResponse, onSuccess, router, postLoginHref]);
 ...
 type="button"
 variant="outline"
 className="w-full rounded-full border border-border py-2.5 flex items-center justify-center gap-2 surface-subtle transition-colors"
