...
import { 
 ...
 Avatar, AvatarFallback, AvatarImage, Label, Textarea,
 Select, SelectContent, SelectItem, SelectTrigger, SelectValue
} from "@jungle/ui";
import { usersApi, api } from "@jungle/api-client";
...
export function OnboardingWizard() {
 ...
 useEffect(() => {
 api.get<{ start_up_avatar?: boolean; start_up_info?: boolean; start_up_follow?: boolean }>("/v1/config/public")
 .then((cfg) => {
 if (!cfg) return;
 ...
 return (
 <Card className="mx-auto w-full max-w-lg border border-t-4 border-t-primary shadow-lg">
 ...
 <Avatar className="h-32 w-32 border-4 border-foreground">
 ...
 <div
 key={user.id}
 className="flex items-center justify-between bg-muted/40 p-2 transition-colors hover:bg-secondary/60"
 >
 ...
 <Button onClick={finish} className="w-full font-semibold">
