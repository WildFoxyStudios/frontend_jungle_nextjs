...
import { 
 Button, Label, Progress, Textarea, Card, CardContent 
} from "@jungle/ui";
...
export function ReelCreator({ onSuccess }: ReelCreatorProps) {
 ...
 className="mx-auto flex aspect-[9/16] max-w-[280px] cursor-pointer flex-col items-center justify-center gap-3 border border-dashed transition-colors hover:bg-secondary/40"
 >
 ...
 <div className="group relative mx-auto aspect-[9/16] max-w-[280px] overflow-hidden border bg-black">
 <video 
 src={preview} 
 ...
 <div className="space-y-1">
 <div className="flex justify-between text-[10px] items-center">
 <span className="text-muted-foreground font-medium">Uploading to Servers</span>
 ...
 disabled={!file || isBusy || isLoading}
 onClick={handleSubmit}
 >
 {(isBusy || isLoading) ? "Sharing..." : (
