...
export default function CreateAdPage() {
 ...
 <div className="space-y-1"><Label htmlFor="ad-campaign-name">Campaign name *</Label><Input id="ad-campaign-name" value={form.name} onChange={(e) => update("name", e.target.value)} /></div>
 <div className="space-y-1"><Label htmlFor="ad-headline">Headline</Label><Input id="ad-headline" value={form.headline} onChange={(e) => update("headline", e.target.value)} /></div>
 <div className="space-y-1"><Label htmlFor="ad-description">Description</Label><Textarea id="ad-description" value={form.description} onChange={(e) => update("description", e.target.value)} rows={2} /></div>
 <div className="space-y-1"><Label htmlFor="ad-url">Destination URL *</Label><Input id="ad-url" type="url" value={form.url} onChange={(e) => update("url", e.target.value)} /></div>
 ...
 <div className="space-y-1"><Label htmlFor="ad-budget">Daily budget (USD)</Label><Input id="ad-budget" type="number" min="1" value={form.daily_budget} onChange={(e) => update("daily_budget", e.target.value)} /></div>
