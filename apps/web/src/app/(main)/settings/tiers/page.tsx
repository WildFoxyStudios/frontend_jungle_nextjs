...
export default function CreatorTiersPage() {
 ...
 <Button variant="ghost" size="icon" aria-label="Edit tier" onClick={() => startEdit(tier)}><Edit2 className="h-4 w-4" /></Button>
 <Button variant="ghost" size="icon" aria-label="Delete tier" className="text-destructive hover:text-destructive" onClick={() => handleDelete(tier.id)}><Trash2 className="h-4 w-4" /></Button>
 </div>
 </CardContent>
 </Card>
 ))}
