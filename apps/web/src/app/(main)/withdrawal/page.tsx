...
export default function WithdrawalPage() {
 ...
 <Label htmlFor="wdl-amount">Amount ({wallet?.currency ?? "USD"})</Label>
 <Input type="number" step="0.01" id="wdl-amount" {...register("amount")} placeholder="0.00" />
 ...
 <div className="space-y-1.5">
 <Label htmlFor="wdl-account">Account Details</Label>
 <Input
 id="wdl-account" {...register("account_details")}
