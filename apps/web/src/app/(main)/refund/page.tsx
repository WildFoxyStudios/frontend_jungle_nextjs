...
export default function RefundPage() {
 ...
 useEffect(() => {
 Promise.all([
 paymentsApi.getProPlans().catch((err) => { console.error("[RefundPage] getProPlans failed", err); return []; }),
 usersApi.getMe().catch((err) => { console.error("[RefundPage] getMe failed", err); return null; }),
 ]).then(([p, user]) => {
 ...
 <Label htmlFor="refund-membership">Membership Type</Label>
