...
export default function EditFundingPage({ params }: Props) {
 ...
 <div
 className="group relative h-40 cursor-pointer overflow-hidden border bg-muted"
 ...
 <Input id="fe-title" value={form.title} onChange={(e) => update("title", e.target.value)} required />
 </div>

 <div className="space-y-1.5">
 <Label htmlFor="fe-story">Story / Description</Label>
 <Textarea
 id="fe-story"
 ...
 <div className="space-y-1.5">
 <Label htmlFor="fe-goal">Goal Amount *</Label>
 <Input id="fe-goal" type="number" min="1" step="0.01" value={form.goal_amount}
 onChange={(e) => update("goal_amount", e.target.value)} required />
 </div>
 <div className="space-y-1.5">
 <Label htmlFor="fe-currency">Currency</Label>
 <Input id="fe-currency" value={form.currency} onChange={(e) => update("currency", e.target.value)} maxLength={3} />
 </div>
 </div>

 <div className="space-y-1.5">
 <Label htmlFor="fe-end-date">End Date</Label>
 <Input id="fe-end-date" type="date" value={form.end_date} onChange={(e) => update("end_date", e.target.value)} />
 </div>
