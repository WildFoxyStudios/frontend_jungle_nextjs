...
export default function CreateFundingPage() {
 ...
 <div className="space-y-1"><Label htmlFor="fc-title">Title *</Label><Input id="fc-title" value={form.title} onChange={(e) => update("title", e.target.value)} /></div>
 <div className="space-y-1"><Label htmlFor="fc-story">Story</Label><Textarea id="fc-story" value={form.description} onChange={(e) => update("description", e.target.value)} rows={4} /></div>
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-1"><Label htmlFor="fc-goal">Goal Amount *</Label><Input id="fc-goal" type="number" min="1" value={form.goal_amount} onChange={(e) => update("goal_amount", e.target.value)} /></div>
 <div className="space-y-1"><Label htmlFor="fc-currency">Currency</Label><Input id="fc-currency" value={form.currency} onChange={(e) => update("currency", e.target.value)} /></div>
 </div>
 <div className="space-y-1"><Label htmlFor="fc-end-date">End date</Label><Input id="fc-end-date" type="date" value={form.end_date} onChange={(e) => update("end_date", e.target.value)} /></div>
