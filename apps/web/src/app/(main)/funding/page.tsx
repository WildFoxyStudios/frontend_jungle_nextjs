  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button asChild><Link href="/funding/create">Start campaign</Link></Button>
      </div>
            ...
            return (
              <Card key={c.id}>
                <CardContent className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">{c.raised_amount} / {c.goal_amount} raised ({pct}%)</p>
                </CardContent>
              </Card>
            );
          })}
