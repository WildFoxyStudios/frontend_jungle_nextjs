...
export default function CreateGroupPage() {
 ...
 <div className="space-y-1"><Label htmlFor="group-name">Group name *</Label><Input id="group-name" value={form.name} onChange={(e) => update("name", e.target.value)} /></div>
 <div className="space-y-1"><Label htmlFor="group-desc">Description</Label><Textarea id="group-desc" value={form.description} onChange={(e) => update("description", e.target.value)} rows={3} /></div>
 <div className="space-y-1"><Label htmlFor="group-category">Category</Label><Input id="group-category" value={form.category} onChange={(e) => update("category", e.target.value)} /></div>
 <div className="space-y-1">
 <Label htmlFor="group-privacy">Privacy</Label>
 <Select value={form.privacy} onValueChange={(v) => update("privacy", v)}>
 <SelectTrigger id="group-privacy"><SelectValue /></SelectTrigger>
 <SelectContent>
