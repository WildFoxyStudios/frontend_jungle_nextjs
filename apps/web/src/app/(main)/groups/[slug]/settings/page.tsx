...
function GroupCoverCard({ group }: { group: Group }) {
 ...
 {coverUrl && (
 <div className="aspect-[3/1] overflow-hidden border bg-muted">
 <Image src={coverUrl} alt="Cover" width={1200} height={400} unoptimized className="w-full h-full object-cover" />
 </div>
 )}
