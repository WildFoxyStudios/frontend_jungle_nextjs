...
export default function GroupFieldsPage({ params }: Props) {
  ...
  useEffect(() => {
    groupsApi.getGroup(slug)
      .then((g) => {
        setGroup(g);
        const ext = g as Group & { custom_fields?: CustomField[] };
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await groupsApi.updateGroup(group.id, { custom_fields: fields } as Partial<Group>);
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Define extra fields members must fill when joining or editing their group profile.
          </p>
              ...
              <div className="flex items-start gap-3">
                <div className="flex-1 space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Profession, Website, City…"
                  />
                </div>
