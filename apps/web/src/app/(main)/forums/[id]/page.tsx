...
import { Card, CardContent, Button, Input, Label, Textarea, Skeleton, Avatar, AvatarFallback, AvatarImage } from "@jungle/ui";
...
export default function ForumDetailPage({ params }: Props) {
 ...
 const loadThreads = useCallback(async (cur?: string) => {
 try {
 ...
 <Button variant="outline" onClick={() => void loadThreads(cursor)}>Load more</Button>
 </div>
 )}
 </div>
 )}
