...
export default function PageSettingsPage({ params }: Props) {
 ...
 <SelectContent>
 {[{ value: "__none__", label: "None" }, ...CTA_OPTIONS].map((opt) => (
 ...
 {page.avatar && (
 <Image src={page.avatar} alt="Avatar" width={80} height={80} unoptimized className="h-20 w-20 rounded-full object-cover border" />
 )}
 ...
 <CardContent className="space-y-3">
 {page.cover && (
 <div className="aspect-[3/1] overflow-hidden bg-muted border">
 <Image src={page.cover} alt="Cover" width={1200} height={400} unoptimized className="w-full h-full object-cover" />
 </div>
 )}
