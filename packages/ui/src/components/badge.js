...
const badgeVariants = cva([
    ...
    variants: {
        variant: {
            ...
            "soft-secondary": "bg-secondary-soft text-secondary-foreground border-secondary/50",
            "soft-accent": "bg-accent-soft text-accent border-accent/40",
            "soft-success": "bg-success-soft text-success border-success/40",
            "soft-warning": "bg-warning-soft text-warning-foreground border-warning/50",
            "soft-info": "bg-info-soft text-info border-info/40",
            "soft-destructive": "bg-destructive-soft text-destructive border-destructive/40",
