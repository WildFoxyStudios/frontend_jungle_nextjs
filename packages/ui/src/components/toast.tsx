...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-sm border bg-card px-3 text-xs font-semibold",
      "shadow-xs transition-all hover:-translate-y-px hover:shadow-sm active:translate-y-0 active:shadow-none",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 grid h-6 w-6 place-items-center rounded-full border bg-card text-foreground opacity-80 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2",
      className
    )}
    toast-close=""
    {...props}
